...
# parseamos las entradas por si el usuario introduce params incorrectos (podemos consultar: python 1_SimpleDirectoryService.py --h)
...
# en este objeto registro: name, uri, address, stop de este agente para poder usar en el codigo
...
# cuando un agente pide que quiere registrase
@app.route("/Register")
def register():
    """
...
def info():
    ...
    global dsgraph
    global mss_cnt
    st = (dsgraph.serialize(format='turtle').decode()) 
